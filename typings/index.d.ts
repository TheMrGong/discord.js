...
declare module 'discord.js' {
  ...
  interface PartialTextBasedChannelFields {
    ...
    send(content: string | (MessageOptions & NoRequeueOption & { split?: false }) | MessageAdditions): Promise<Message>;
    ...
    send(content: string | null, options: MessageOptions & NoRequeueOption): Promise<Message | Message[]>;
  }
